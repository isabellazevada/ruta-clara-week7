...
## Persona test · 25 September 2026

A fresh-chat synthetic driver persona reviewed four ordered screenshots. Her main failure point was reading “1 sin resolver” after submitting context as evidence that her answer had not been saved. The UI now calls this count “pendiente de revisión”, confirms that the response is saved only in the demo, explains that there is no active reviewer, and contextualizes the simulated 99% signal. All three local tests passed. **Next first move:** publish this and the visual packet commit, redeploy Vercel, check the changed live copy, and then record the deployment; do not claim that this has happened yet.
